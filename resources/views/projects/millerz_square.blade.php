...
@section('content')
    <div class="blog-page">
        <div class="page-header" data-parallax="true"
             style="background-image: url({{ asset('images/properties/millerz/project_header.jpg') }})">
            <div class="filter"></div>
            <div class="content-center">
                <div class="motto">
                    <h1 class="title-uppercase text-center">Millerz Square</h1>
                    <h3 class="text-center">The New Landmark of Mixed-Development.</h3>
                    <br/>
                            ...
                            <div class="col-md-8 ml-auto mr-auto">
                                <a href="javascrip: void(0);">
                                    <div class="card" data-radius="none"
                                         style="background-image: url({{ asset('images/properties/millerz/main.jpg') }});"></div>
                                    <p class="image-thumb text-center">Photo by Cam Adams</p>
                                </a>
                                <div class="article-content">
                                    <p>
                                        Tropicana Heights spreads over 198.5 acres of freehold land and is poised to
                                        become another premium mixed development in Kajang. Surrounded by green
                                        landscaping and serviced by existing amenities within the surrounding
                                        neighbourhood, Tropicana Heights is also linked to major hubs around the Klang
                                        Valley by a network of highways.
                                    </p>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">1994 sq ft - 3931 sq ft</td>
                                            </tr>
                                            <tr>
                                                <td><strong>Number of Towers:</strong></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">2/3/4</td>
                                            </tr>
                                            <tr>
                                                <td><strong>Number of Bathrooms:</strong></td>
                                                <td class="text-right">1/2/3</td>
                                            </tr>
                                            <tr>
                                                <td><strong>Date of Completion:</strong></td>
                                                <td class="text-right">01-Jan-2019 (3 years from now)</td>
                                            </tr>
                                    ...
                                    <div class="card" data-radius="none"
                                         style="background-image: url({{ asset('images/properties/millerz/facilities.png') }});">
