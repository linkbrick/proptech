<template>
    <div>
        <div class="card">
            ...
            <a v-if="canCreate" href="#" class="btn btn-primary btn-simple pull-right" @click.prevent="creating.active = !creating.active">{{ creating.active ? 'Hide' : 'New record' }} </a>
            <a v-if="canCreateCustomPage" :href="response.allow.creation" class="btn btn-primary btn-simple pull-right" >New record</a>
            ...
            <div class="card-content">
                ...
                <div class="panel panel-default">
                    <div class="well" style="background-color:#fff" v-if="response.allow.creation && creating.active" >
                        <form action="#" class="form-horizontal" @submit.prevent="store">
                            <div class="form-group label-floating" v-for="column in response.updatable" :class="{ 'has-error': creating.errors[column] }">
                                <label :for="column" class="control-label">{{ column }}</label>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                            ...
                            <table class="table table-striped">
                                ...
                                <tr v-for="record in filteredRecords">
                                    ...
                                    <td class="td-actions">
                                        ...
                                        <a v-if="canUpdate(record)" href="#" @click.prevent="edit(record)" class="btn btn-success">
                                            <i class="material-icons">edit</i>
                                        </a>
                                        <a v-if="canUpdateCustomPage()" :href="response.allow.update+'/'+record.id+'/edit'" class="btn btn-success" ><i class="material-icons">edit</i></a>

                                        <a v-if="canView" :href="response.allow.view+'/'+record.id+''" class="btn btn-primary" ><i class="material-icons">view_headline</i></a>
                                        ...
                                        <a href="#" @click.prevent="destroy(record.id)" v-if="response.allow.deletion" class="btn btn-danger">
                        ...
                        <h5 class="text-primary" v-else>No results</h5>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            canCreate () {
                return typeof(this.response.allow.creation) === 'boolean' && this.response.allow.creation
            },
            canCreateCustomPage () {
                return typeof(this.response.allow.creation) === 'string' && this.response.allow.creation
            },
            canView () {
                return typeof(this.response.allow.view) === 'string'
            }
        ...
        methods: {
            ...
            canUpdate (record) {
                return typeof(this.response.allow.update) === 'boolean' && this.response.allow.update && this.editing.id !== record.id
            },
            canUpdateCustomPage () {
                return this.response.allow.update && typeof(this.response.allow.update) === 'string'
            }
        },
        mounted () {
            this.getRecords()
